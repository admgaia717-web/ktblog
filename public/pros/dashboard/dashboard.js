 ...
 * データ源: 2026-09-03 第1回定例（Zoom, 100分）文字起こし + 8/27 キックオフ記録
...
const ISSUES = [
  ...
  { level: 'mid', title: 'LINE公式アカウントがまだ無い', body: '集客LINEの配信の仕組みは 9/6 に完成。あとは開設だけだが、名義・電話番号・プロフィールはプロス側で決める必要があり、AIだけでは作れない。', owner: ['kitaura', 'tamagawa'], action: '北浦先生が15分で開設 → トークンをKTへ → 接続はエージェント（詳しくは「集客 LINE」のカード）' },
