...
const MEMBERS = {
  ...
  agent:    { name: 'オ課長', role: 'AIエージェント（Hermes）', color: 'sky', initial: 'オ' },
...
const FLOW = [
  ...
  { from: 8, to: 27, title: '「100円動画」の正体と拡散戦略', who: ['tamagawa', 'motoyama'],
    points: ['踊るリンゴ動画＝11秒で約100円。エージェントがプロスHPを読んで自分で筋書きを作った', '幼児向け（プロスフォニックス）から積み上げる。上位は市販教科書なので売れない', 'SNS（TikTok・YouTube・X・Instagram）で無料拡散→フィードバック→欲しい教材を作る→販売', '先生自身がエージェント「オ課長」に指示して作る。KT が最初にお手本'],
    decision: '4人でオ課長を共有し、先生が直接指示して作る' },
  ...
  { from: 58, to: 72, title: 'アプリと拡散を同時に進める', who: ['tamagawa', 'kitaura', 'motoyama'],
    points: ['マークの動画→動画生成でジェスチャーをコピー、手にリンゴを乗せる等も可能', 'Telegram の使い分け：人間界（人へ）／システム（オ課長へ）', '1文字できればエージェントが 3D・2D アニメに展開できる', '北浦先生の SNS 運用（HP・FB・Instagram・GBP）をエージェントに移管。TikTok・LINE を追加'],
...
const TASKS = [
  // 玉川（KT）
  { id: 'kt-01', owner: 'tamagawa', title: '今回の生録音をオ課長に読み込ませ、アクションプランを4人に共有', due: '9/5', tag: '最優先', done: true, note: 'このダッシュボードが成果物' },
  ...
  // 本山先生
  { id: 'mo-01', owner: 'motoyama', title: 'Zoom の録音（生声）を KT とオ課長のシステム側に送る', due: '9/4', tag: '最優先' },
...
/* 決定事項 */
const DECISIONS = [
  { title: '4人でオ課長を共有し、先生が直接指示して作る', body: 'KT が最初にお手本の指示。無理な指示は KT・蜂谷さんが途中で解釈を入れる。' },
