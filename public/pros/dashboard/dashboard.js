...
const MEMBERS = {
  ...
  agent:    { name: 'マー君', role: 'AIエージェント', color: 'sky', initial: 'M' },
  all:      { name: '全員', role: '4人＋マー君', color: 'peach', initial: '全' },
};
...
const FLOW = [
  ...
  { from: 8, to: 27, title: '「100円動画」の正体と拡散戦略', who: ['tamagawa', 'motoyama'],
    points: ['踊るリンゴ動画＝11秒で約100円。エージェントがプロスHPを読んで自分で筋書きを作った', '幼児向け（プロスフォニックス）から積み上げる。上位は市販教科書なので売れない', 'SNS（TikTok・YouTube・X・Instagram）で無料拡散→フィードバック→欲しい教材を作る→販売', '先生自身がエージェント「マー君」に指示して作る。KT が最初にお手本'],
    decision: '4人でマー君を共有し、先生が直接指示して作る' },
  ...
  { from: 58, to: 72, title: 'アプリと拡散を同時に進める', who: ['tamagawa', 'kitaura', 'motoyama'],
    points: ['マークの動画→動画生成でジェスチャーをコピー、手にリンゴを乗せる等も可能', 'Telegram の使い分け：人間界（人へ）／システム（マー君へ）', '1文字できればエージェントが 3D・2D アニメに展開できる', '北浦先生の SNS 運用（HP・FB・Instagram・GBP）をエージェントに移管。TikTok・LINE を追加'],
...
const ROADMAP = [
  { stage: 'STAGE 0', name: '準備・お手本', start: 1, span: 1, color: 'sky',
    goals: ['録音→マー君に読み込み', 'A・B・C 動画試作', '設定説明書・音声入力導入', '9/17 で確認'] },
  { stage: 'STAGE 1', name: 'A〜G アバターアプリ＋SNS 開始', start: 1, span: 2, color: 'apple',
    goals: ['ジェスチャー付きアバター A〜G', 'メイキング動画で SNS 先行', '既存 SNS・TikTok・LINE 接続', '先生が直接マー君に指示'] },
...
const TASKS = [
  // 玉川（KT）
  { id: 'kt-01', owner: 'tamagawa', title: '今回の生録音をマー君に読み込ませ、アクションプランを4人に共有', due: '9/5', tag: '最優先', done: true, note: 'このダッシュボードが成果物' },
  ...
  { id: 'kt-04', owner: 'tamagawa', title: 'マー君への「お手本の指示」を出し、指示の仕方を先生方に見せる', due: '9/10', tag: 'お手本' },
  ...
  // 本山先生
  { id: 'mo-01', owner: 'motoyama', title: 'Zoom の録音（生声）を KT とマー君のシステム側に送る', due: '9/4', tag: '最優先' },
  { id: 'mo-02', owner: 'motoyama', title: 'KT のお手本の後、マー君に直接指示して動画を1本作ってみる', due: '9/17', tag: '体験' },
  ...
  // 北浦先生
  { id: 'ki-01', owner: 'kitaura', title: 'マー君に指示して Annie Apple 動画を作ってみる（手にリンゴ→口へ→「あっ」）', due: '9/17', tag: '体験' },
  ...
  // マー君
  { id: 'ag-01', owner: 'agent', title: '9/3 会議の録音を読み込み、プロジェクトのコンテキストを保持', due: '9/5', tag: '記憶', done: true },
  { id: 'ag-02', owner: 'agent', title: 'A・B・C のジェスチャー動画を生成（KT・先生方の指示で）', due: '9/17', tag: '生成' },
  { id: 'ag-03', owner: 'agent', title: '26キャラのストーリーを指示テンプレートに言語化', due: '9/17', tag: '整理' },
...
/* 決定事項 */
const DECISIONS = [
  { title: '4人でマー君を共有し、先生が直接指示して作る', body: 'KT が最初にお手本の指示。無理な指示は KT・蜂谷さんが途中で解釈を入れる。' },
