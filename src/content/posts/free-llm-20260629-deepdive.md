---
title: "🔬 【2026-06-29】モデル深掘り — 実力検証"
date: 2026-06-29
slug: "free-llm-20260629-deepdive"
category: "AI・テクノロジー"
...
> **2026-06-29 12:00 JST** · 毎日02・08・12・17・22時更新  
> 特定モデルの性能・ベンチマーク評価  
...
| 項目 | 値 |
|------|-----|
| モデルID | `qwen/qwen3-coder:free` |
| コンテキスト長 | 1,048,576 tokens |
| 価格 | **無料** ($0) |
| モダリティ | text->text |
| Tokenizer | Qwen3 |
| リンク | [OpenRouter](https://openrouter.ai/models/qwen/qwen3-coder:free) |
...
| [Qwen: Qwen3 Coder 480B A35B (free)](https://openrouter.ai/models/qwen/qwen3-coder:free) | 1,048,576 | 長文分析・RAG・コード生成 |
