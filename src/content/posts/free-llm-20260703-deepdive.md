---
title: "🔬 【2026-07-03】モデル深掘り — 実力検証"
date: 2026-07-03
slug: free-llm-20260703-deepdive
category: "AI・テクノロジー"
...
> **2026-07-03 12:00 JST** · 毎日02・08・12・17・22時更新  
> 特定モデルの性能・ベンチマーク評価  
...
| 項目 | 値 |
|------|-----|
| モデルID | `openai/gpt-oss-120b:free` |
| コンテキスト長 | 131,072 tokens |
| 価格 | **無料** ($0) |
| モダリティ | text->text |
| Tokenizer | GPT |
| リンク | [OpenRouter](https://openrouter.ai/models/openai/gpt-oss-120b:free) |
...
| [OpenAI: gpt-oss-120b (free)](https://openrouter.ai/models/openai/gpt-oss-120b:free) | 131,072 | チャット・軽量タスク |
