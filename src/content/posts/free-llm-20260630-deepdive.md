---
title: "🔬 【2026-06-30】モデル深掘り — 実力検証"
date: 2026-06-30
slug: "free-llm-20260630-deepdive"
category: "AI・テクノロジー"
eyecatch: "/assets/eyecatch/hero-local-ai.png"
excerpt: "本日ピックアップ3モデルの詳細スペック・コンテキスト・価格体系・リンクを徹底比較。"
tags: ["LLM", "モデル比較", "OpenRouter", "深掘り", "日次更新", "ロボット", "AIエージェント"]
---
...
| モダリティ | text->text |
| Tokenizer | Cohere |
| リンク | [OpenRouter](https://openrouter.ai/models/cohere/north-mini-code:free) |
...
| 項目 | 値 |
|------|-----|
| モデルID | `nvidia/nemotron-nano-9b-v2:free` |
| コンテキスト長 | 128,000 tokens |
| 価格 | **無料** ($0) |
| モダリティ | text->text |
| Tokenizer | Other |
| リンク | [OpenRouter](https://openrouter.ai/models/nvidia/nemotron-nano-9b-v2:free) |
...
| モデル | コンテキスト | 用途 |
|--------|------------|------|
| [Cohere: North Mini Code (free)](https://openrouter.ai/models/cohere/north-mini-code:free) | 256,000 | 文書分析・エージェント |
| [Owl Alpha](https://openrouter.ai/models/openrouter/owl-alpha) | 1,048,756 | 長文分析・RAG・コード生成 |
| [NVIDIA: Nemotron Nano 9B V2 (free)](https://openrouter.ai/models/nvidia/nemotron-nano-9b-v2:free) | 128,000 | チャット・軽量タスク |
