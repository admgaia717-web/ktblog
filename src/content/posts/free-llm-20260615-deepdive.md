---
title: "🔬 【2026-06-15】モデル深掘り — 実力検証"
date: 2026-06-15
slug: free-llm-20260615-deepdive
category: "AI・テクノロジー"
...
| 項目 | 値 |
|------|-----|
| モデルID | `cognitivecomputations/dolphin-mistral-24b-venice-edition:free` |
| コンテキスト長 | 32,768 tokens |
| 価格 | **無料** ($0) |
| モダリティ | text->text |
| Tokenizer | Other |
| リンク | [OpenRouter](https://openrouter.ai/models/cognitivecomputations/dolphin-mistral-24b-venice-edition:free) |
...
| 項目 | 値 |
|------|-----|
| モデルID | `qwen/qwen3-next-80b-a3b-instruct:free` |
| コンテキスト長 | 262,144 tokens |
| 価格 | **無料** ($0) |
| モダリティ | text->text |
| Tokenizer | Qwen3 |
| リンク | [OpenRouter](https://openrouter.ai/models/qwen/qwen3-next-80b-a3b-instruct:free) |
...
| モデル | コンテキスト | 用途 |
|--------|------------|------|
| [Venice: Uncensored (free)](https://openrouter.ai/models/cognitivecomputations/dolphin-mistral-24b-venice-edition:free) | 32,768 | チャット・軽量タスク |
| [Google: Gemma 4 31B (free)](https://openrouter.ai/models/google/gemma-4-31b-it:free) | 262,144 | 文書分析・エージェント |
| [Qwen: Qwen3 Next 80B A3B Instruct (free)](https://openrouter.ai/models/qwen/qwen3-next-80b-a3b-instruct:free) | 262,144 | 文書分析・エージェント |
