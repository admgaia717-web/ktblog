---
title: "🔬 【2026-06-17】モデル深掘り — 実力検証"
date: 2026-06-17
slug: free-llm-20260617-deepdive
category: "AI・テクノロジー"
...
> **2026-06-17 12:00 JST** · 毎日02・08・12・17・22時更新  
> 特定モデルの性能・ベンチマーク評価  
...
| 項目 | 値 |
|------|-----|
| モデルID | `nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free` |
| コンテキスト長 | 256,000 tokens |
| 価格 | **無料** ($0) |
| モダリティ | text+image+audio+video->text |
| Tokenizer | Other |
| リンク | [OpenRouter](https://openrouter.ai/models/nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free) |
...
| 項目 | 値 |
|------|-----|
| モデルID | `liquid/lfm-2.5-1.2b-instruct:free` |
| コンテキスト長 | 32,768 tokens |
| 価格 | **無料** ($0) |
| モダリティ | text->text |
| Tokenizer | Other |
| リンク | [OpenRouter](https://openrouter.ai/models/liquid/lfm-2.5-1.2b-instruct:free) |
...
| モデル | コンテキスト | 用途 |
|--------|------------|------|
| [NVIDIA: Nemotron 3 Nano Omni (free)](https://openrouter.ai/models/nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free) | 256,000 | 文書分析・エージェント |
| [NVIDIA: Nemotron 3 Super (free)](https://openrouter.ai/models/nvidia/nemotron-3-super-120b-a12b:free) | 1,000,000 | 長文分析・RAG・コード生成 |
| [LiquidAI: LFM2.5-1.2B-Instruct (free)](https://openrouter.ai/models/liquid/lfm-2.5-1.2b-instruct:free) | 32,768 | チャット・軽量タスク |
